		  ...
		  <view class="u-demo-block">
			  ...
			  <view class="page-body">
			  	<view class="page-section">
			  		<video id="myVideo" src="https://blog-leo021017.oss-cn-beijing.aliyuncs.com/wx-delay.mp4" @error="videoErrorCallback" :danmu-list="danmuList"
