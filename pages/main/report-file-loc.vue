<template>
	  <view class="u-page">
		  ...
		  <view class="u-demo-block">
			  <text class="u-demo-block__title" style="font-size: 100%; font-weight: 800; color: black; margin-left: 5%; margin-top: 0ch;">检测文件</text>
			  <view class="page-body">
			  	<view class="page-section">
			  		<video id="myVideo" src="https://blog-leo021017.oss-cn-beijing.aliyuncs.com/file.mp4" @error="videoErrorCallback" :danmu-list="danmuList"
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  <text class="u-demo-block__title" style="font-size: 100%; font-weight: 800; color: black; margin-left: 5%; margin-top: 0ch;">小段伪造检测</text>
					  <view style="border-radius: 20rpx;">
			  <image src="../../static/loc.gif" style="display:block; margin:0 auto;border-radius: 40rpx;"></image>
			  <br />
			  <image src="../../static/loc.png" style="display:block; margin:0 auto;border-radius: 40rpx; height:7ch; width: 60ch; margin-left: -10ch;"></image>
			  <text style="display:block; font-size: 70%; font-weight: bold; color: gray; margin-top: 0ch; margin-left: 5%;">视频在1.84s~1.97s处存在异常编辑情况</text>
					  </view>
		  </view>
...
<!-- 		  <view class="u-demo-block" style="border-radius: 12rpx">
			  ...
			  <view style="border-radius: 20rpx;">
		  	  <image src="../../static/face.png" style="display:block; margin:0 auto;border-radius: 40rpx; width: 75%"></image>
			  </view>
		  </view>
