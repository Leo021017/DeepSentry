<template>
	  <view class="u-page">
		  ...
		  <view class="u-demo-block">
			  ...
			  <view class="page-body">
			  	<view class="page-section">
			  		<video id="myVideo" src="https://blog-leo021017.oss-cn-beijing.aliyuncs.com/douyin.mp4" @error="videoErrorCallback" :danmu-list="danmuList"
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  ...
			  <image src="../../static/delay-douyin.png" style="display:block; margin:0 auto;border-radius: 40rpx; height:7ch; width: 60ch; margin-left: -10ch;"></image>
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  ...
			  <view style="border-radius: 20rpx;">
		  	  <image src="../../static/douyin-face.png" style="display:block; margin:0 auto;border-radius: 40rpx; width: 75%"></image>
			  </view>
		  </view>
