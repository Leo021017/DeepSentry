<template>
	  <view class="u-page">
		  ...
		  <view class="u-demo-block">
			  <text class="u-demo-block__title" style="font-size: 100%; font-weight: 800; color: black; margin-left: 5%; margin-top: 0ch;">欺诈录屏回放</text>
			  <view class="page-body">
			  	<view class="page-section">
			  		<video id="myVideo" src="https://blog-leo021017.oss-cn-beijing.aliyuncs.com/douyin-record.mp4" @error="videoErrorCallback" :danmu-list="danmuList"
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  ...
			  <image src="../../static/delay-dy.png" style="display:block; margin:0 auto;border-radius: 40rpx; height:7ch; width: 60ch; margin-left: -10ch;"></image>
			  <text style="display:block; font-size: 70%; font-weight: bold; color: gray; margin-top: 0ch; margin-left: 5%;">平均延迟为44ms，网络延迟情况良好</text>
					  </view>
		  </view>
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  ...
			  <view style="border-radius: 20rpx;">
		  	  <image src="../../static/doyu-face.png" style="display:block; margin:0 auto;border-radius: 40rpx; width: 75%"></image>
			  </view>
		  </view>
