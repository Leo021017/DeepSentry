<template>
	  <view class="u-page">
		  ...
		  <view class="u-demo-block">
			  ...
			  <view class="page-body">
			  	<view class="page-section">
			  		<video id="myVideo" src="https://blog-leo021017.oss-cn-beijing.aliyuncs.com/meet-bty.mp4" @error="videoErrorCallback" :danmu-list="danmuList"
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  ...
			  <image src="../../static/delay-meet.png" style="display:block; margin:0 auto;border-radius: 40rpx; height:7ch; width: 60ch; margin-left: -10ch;"></image>
			  <text style="display:block; font-size: 70%; font-weight: bold; color: gray; margin-top: 0ch; margin-left: 5%;">平均延迟为60ms，网络延迟情况良好</text>
					  </view>
		  </view>
		  ...
		  <view class="u-demo-block" style="border-radius: 12rpx;">
			  ...
			  <view style="border-radius: 20rpx;">
		  	  <image src="../../static/meet-bty.png" style="display:block; margin:0 auto;border-radius: 40rpx; width: 75%"></image>
			  </view>
		  </view>
